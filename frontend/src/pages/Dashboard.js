...
//   const backendResponse = location.state?.backendResponse || null; // Use the correct property name
//   const formData = location.state?.formData || null; // Access formData if needed
